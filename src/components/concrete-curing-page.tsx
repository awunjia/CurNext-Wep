...
export async function ConcreteCuringPage() {
  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section aria-labelledby="cn-cc-related-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          ...
          <ul className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <li>
              <Link href="/contact" className="group block outline-none">
                <span className="text-muted-foreground text-xs font-medium tracking-[0.14em] uppercase">{tShared("sales")}</span>
                <span className="mt-1 flex items-center gap-1.5 text-base font-medium tracking-tight">
                  {tShared("contact")}
                  <ArrowRight className="size-3.5 opacity-50 transition-transform group-hover:translate-x-0.5 group-hover:opacity-100" aria-hidden />
                </span>
