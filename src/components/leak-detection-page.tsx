...
const problemIcons = [Droplets, Timer, ClipboardCheck] as const;
const measureIcons = [Waves, Radio, Droplets] as const;
const measureKeys = ["1", "2", "3"] as const;
const zoneIcons = [Building2, ShowerHead, Waves] as const;
const zoneKeys = ["1", "2", "3"] as const;
const uplinkKeys = ["1", "2"] as const;

export async function LeakDetectionPage() {
  const locale = await getLocale();
  const t = await getTranslations("solutions.leak-detection");
  ...
  return (
    <main className="flex flex-1 flex-col">
      <SolutionProductJsonLd
        ...
        imagePath="/solutions/cn-leak-hero.jpg"
        faq={faq}
        steps={steps}
      ...
      <section aria-labelledby="cn-leak-outcomes-heading" className="relative w-full bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">
              {t("outcomesEyebrow")}
            </p>
            <h3 id="cn-leak-outcomes-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">
              {t("outcomesTitle")}
            </h3>
      ...
      <section aria-labelledby="cn-leak-challenge-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">
              {t("challengeEyebrow")}
            </p>
            <h3 id="cn-leak-challenge-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">
              {t("challengeTitle")}
            </h3>
          </div>
      ...
      <section aria-labelledby="cn-leak-what-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16">
            <div className="min-w-0">
              <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">CN-LEAK</p>
              <h3 id="cn-leak-what-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("whatTitle")}</h3>
            ...
            <div className="relative aspect-[4/3] overflow-hidden sm:aspect-[5/4]">
              <Image src="/solutions/cn-leak-hero.jpg" alt={t("whatAlt")} fill sizes="(max-width: 1024px) 100vw, 40vw" className="object-cover object-center" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section aria-labelledby="cn-leak-measures-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("measuresEyebrow")}</p>
            <h3 id="cn-leak-measures-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("measuresTitle")}</h3>
      ...
      <section aria-labelledby="cn-leak-how-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{tShared("howItWorks")}</p>
            <h3 id="cn-leak-how-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("howTitle")}</h3>
          </div>
      ...
      <section aria-labelledby="cn-leak-zones-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("zonesEyebrow")}</p>
            <h3 id="cn-leak-zones-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("zonesTitle")}</h3>
      ...
      <section aria-labelledby="cn-leak-uplink-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("uplinkEyebrow")}</p>
            <h3 id="cn-leak-uplink-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("uplinkTitle")}</h3>
      ...
      <section aria-labelledby="cn-leak-trust-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("trustEyebrow")}</p>
            <h3 id="cn-leak-trust-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("trustTitle")}</h3>
          </div>
