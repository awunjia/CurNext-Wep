...
const problemIcons = [Timer, ClipboardCheck, Zap] as const;
const measureIcons = [Waves, Gauge, Zap] as const;
const measureKeys = ["1", "2", "3"] as const;
const uplinkKeys = ["1", "2"] as const;

export async function MepPage() {
  const locale = await getLocale();
  const t = await getTranslations("solutions.mep");
  ...
  return (
    <main className="flex flex-1 flex-col">
      <SolutionProductJsonLd
        ...
        imagePath="/solutions/cn-mep-hero.jpg"
        faq={faq}
        steps={steps}
      ...
      <section aria-labelledby="cn-mep-outcomes-heading" className="relative w-full bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">
              {t("outcomesEyebrow")}
            </p>
            <h3 id="cn-mep-outcomes-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">
              {t("outcomesTitle")}
            </h3>
      ...
      <section aria-labelledby="cn-mep-challenge-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">
              {t("challengeEyebrow")}
            </p>
            <h3 id="cn-mep-challenge-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">
              {t("challengeTitle")}
            </h3>
          </div>
      ...
      <section aria-labelledby="cn-mep-what-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-16">
            <div className="min-w-0">
              <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">CN-MEP</p>
              <h3 id="cn-mep-what-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("whatTitle")}</h3>
            ...
            <div className="relative aspect-[4/3] overflow-hidden sm:aspect-[5/4]">
              <Image src="/solutions/cn-mep-hero.jpg" alt={t("whatAlt")} fill sizes="(max-width: 1024px) 100vw, 40vw" className="object-cover object-center" />
            </div>
          </div>
        </div>
      </section>

      <section aria-labelledby="cn-mep-measures-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("measuresEyebrow")}</p>
            <h3 id="cn-mep-measures-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("measuresTitle")}</h3>
      ...
      <section aria-labelledby="cn-mep-uplink-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("uplinkEyebrow")}</p>
            <h3 id="cn-mep-uplink-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("uplinkTitle")}</h3>
      ...
      <section aria-labelledby="cn-mep-how-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{tShared("howItWorks")}</p>
            <h3 id="cn-mep-how-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("howTitle")}</h3>
          </div>
      ...
      <section aria-labelledby="cn-mep-trust-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <div className="max-w-2xl">
            <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{t("trustEyebrow")}</p>
            <h3 id="cn-mep-trust-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{t("trustTitle")}</h3>
          </div>
      ...
      <section aria-labelledby="cn-mep-related-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{tShared("related")}</p>
          <h3 id="cn-mep-related-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{tShared("moreOnStack")}</h3>
          <ul className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
            <li>
              <Link href="/solutions/leak-detection" className="group block outline-none">
                <span className="text-muted-foreground text-xs font-medium tracking-[0.14em] uppercase">{"CN-LEAK"}</span>
            ...
            <li>
              <Link href="/solutions/concrete-curing" className="group block outline-none">
                <span className="text-muted-foreground text-xs font-medium tracking-[0.14em] uppercase">{"CN-CC"}</span>
                <span className="mt-1 flex items-center gap-1.5 text-base font-medium tracking-tight">
                  {t("related2Label")}
                  <ArrowRight className="size-3.5 opacity-50 transition-transform group-hover:translate-x-0.5 group-hover:opacity-100" aria-hidden />
                </span>
