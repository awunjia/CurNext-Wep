...
export async function StructuralHealthPage() {
  ...
  return (
    <main className="flex flex-1 flex-col">
      ...
      <section aria-labelledby="cn-shm-related-heading" className="border-border/60 relative w-full border-t bg-background">
        <div className="mx-auto w-full max-w-6xl px-4 py-14 sm:px-6 sm:py-20 md:py-24">
          <p className="text-muted-foreground mb-3 text-xs font-medium tracking-[0.18em] uppercase">{tShared("related")}</p>
          <h3 id="cn-shm-related-heading" className="text-xl font-semibold tracking-tight sm:text-2xl">{tShared("moreOnStack")}</h3>
