...
type SubscribeConfirmationEmailInput = {
  email: string;
};
...
export function buildSubscribeConfirmationEmail(
  input: SubscribeConfirmationEmailInput,
) {
  ...
  const subject = "You are subscribed to CurNext updates";
  const preview =
    "Thanks for subscribing - you will get product updates and site intelligence notes from CurNext.";

  const text = [
    "Hi,",
    "",
    "Thanks for subscribing to CurNext updates. You are on the list for product news, site intelligence notes, and release highlights.",
    "",
    ...
    "---",
    "Security notice",
    "This message was sent because this email subscribed to the CurNext newsletter on curnext.app. CurNext will never ask you for passwords or payment details by email.",
    `If you did not subscribe, contact ${process.env.SMTP_FROM_NOREPLY ?? "info@curnext.app"} or ignore this message.`,
    "",
    `Privacy: ${privacyUrl}`,
    `Terms: ${termsUrl}`,
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="padding:34px 32px 28px;">
                    <p style="margin:0 0 10px;font-size:11px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#71717a;font-family:${font};">Newsletter</p>
                    <h1 style="margin:0 0 14px;font-size:24px;line-height:1.25;font-weight:600;color:#fafafa;font-family:${font};">You are subscribed</h1>
                    <p style="margin:0 0 18px;font-size:15px;line-height:1.7;color:#a1a1aa;font-family:${font};">
                      Thanks for joining the CurNext list. You will receive product updates, site intelligence notes, and release highlights - occasional, no fluff.
                    </p>
                      ...
                      <tr>
                        <td style="padding:16px 18px;">
                          ...
                          <p style="margin:0 0 10px;font-size:12px;line-height:1.6;color:#a1a1aa;font-family:${font};">
                            This email was sent because this address subscribed to the CurNext newsletter on curnext.app.
                          ...
                          <p style="margin:0;font-size:12px;line-height:1.6;color:#a1a1aa;font-family:${font};">
                            If you did not subscribe, you can safely ignore this message or contact
